...
if __name__ == '__main__':
    print("Public Efficiency Test Case 1 - Efficiency tests function 'label_assign'")
    try:
        with HiddenPrints():
            ...
            labels = label_assign(word_probs)
            end_time = time.time()
            print(labels)
        ...
        if execution_time <= time_threshold:
            ...
            print(False)
            print(f"label_assign is too slow. Execution time: {execution_time:.6f} seconds (threshold: {time_threshold} seconds)")
